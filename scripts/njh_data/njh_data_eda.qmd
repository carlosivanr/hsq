...
data = pd.read_csv(here("scripts/njh_data/data/prepped/njh_data_02-18-2026.csv"), header = 0)

# Strip the trailing spaces from the column names
data.columns = data.columns.str.strip()
```

```{python}
# Load the OH data
oh = pd.read_csv(here("scripts/njh_data/data/prepped/njh_data_OH_03-21-2025.csv"), header = 0)
...
```{python}
#| eval: false
# Check the time windows and the column names

```

```{python}
# Ensure that all column names are harmonized. Some had trailing spaces while 
# others had "Desc" appended to the column name
