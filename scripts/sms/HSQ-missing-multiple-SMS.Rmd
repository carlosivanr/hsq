...
```{r, echo = FALSE}
# Load the no contact list to remove people who do not wish to be contacted from
# the final report
if (file.exists("Z:/Shared/DFM/HSQ_Shared/Reporting/2 week SMS report/SMS_reminder_call_contact_list.csv")) {
  
  # Task scheduler does not play well with Egnyte. It cannot read nor write
  # files, so an alternative is to place the no contact list in OneDrive as 
  # a short term fix.
  contact_list <-
    # read_csv("Z:/Shared/DFM/HSQ_Shared/Reporting/2 week SMS report/SMS_reminder_call_contact_list.csv",
    #          show_col_types = FALSE)
    read_csv("C:/Users/rodrica2/OneDrive - The University of Colorado Denver/Documents/DFM/projects/hsq/hsq_shared/sms/SMS_reminder_call_contact_list.csv",
             show_col_types = FALSE)
  ...
  stop("The contact list cannot be found at Z:/Shared/DFM/HSQ_Shared/Reporting/2 week SMS report/SMS_reminder_call_contact_list.csv. Please verify the file is in place")
}

```

```{r, eval = FALSE, echo = FALSE}
There are some individuals who should appear in the contact list but do not
Check the following
90332
