...
# generates and then uploads their digrams back to redcap. This is a required
...
rmarkdown::render("C:/Users/rodrica2/OneDrive - The University of Colorado Denver/Documents/DFM/projects/hsq/Helpers-Stay-Quit/03 Code/qualitative_diagrams.Rmd")
```
...
data %>%
  ...
  writexl::write_xlsx(., path = here(str_c("dyad_report_", Sys.Date(), ".xlsx")))
